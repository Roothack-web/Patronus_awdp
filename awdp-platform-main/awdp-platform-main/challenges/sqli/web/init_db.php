...
if (!$db) {
    die("Cannot connect to MySQL after $max_attempts attempts.\n");
}
...
INSERT INTO `articles` (`title`, `content`, `category_id`, `author`, `view_count`, `image_url`) VALUES
...
('《流浪地球3》定档春节，刘慈欣担任编剧', '备受期待的科幻巨制《流浪地球3》正式宣布定档2025年春节档，并发布首支预告片。导演郭帆透露，第三部将全面升级特效制作水准，故事将延续前两部的宏大叙事，同时加入全新角色和更加复杂的情感线索。原著作者刘慈欣亲自参与编剧工作。', 4, '陈雨', 15892, 'https://picsum.photos/seed/movie/800/400'),
('欧盟就碳中和达成新协议，2035年禁售燃油车', '欧盟委员会昨日宣布，各成员国已就2035年全面禁售燃油汽车达成最终协议，并同意设立 3000 亿欧元的绿色转型基金。此举被视为全球应对气候变化的重要里程碑，宝马、大众等欧洲车企随即发布声明表示支持，并加速推进电动化战略。', 5, '赵薇', 6543, 'https://picsum.photos/seed/eu/800/400');
